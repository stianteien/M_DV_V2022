...
class serie_unet(vanilla_unet):
    ...
    def get_unet(self, input_img1, n_filters = 16, dropout = 0.1,
        ...
        # Contracting Path 2
        c1_2 = self.conv2d_block(c11, n_filters * 1, kernel_size = 3, batchnorm = batchnorm)
        ...
        outputs = Conv2D(n_classes, (1, 1), activation=last_activation)(c9_2)
        model = Model(inputs=[m1], outputs=[outputs])
        return model