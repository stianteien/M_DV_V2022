...
class unet_2input(vanilla_unet):
    """
    ...
    def get_unet(self, input_img1, input_img2, n_filters = 16, dropout = 0.1,
        ...
        m3 = self.rationalConvTransposed(m2, start=56,end=128)
        m4 = concatenate([m1, m3])

        # Contracting Path
        c1 = self.conv2d_block(m4, n_filters * 1, kernel_size = 3, batchnorm = batchnorm)
